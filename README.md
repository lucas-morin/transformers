...
This fork contains the code for the architecture of MarkushGrapher. It is created by modifying the file `modeling_udop.py` of the UDOP model. The code is stored at `src/transformers/models/markushgrapher/`.
